...
if (isset($_REQUEST['create_from'])) {
    $createFromCheck = array('create_from' => array(Zynas_Filter_Input::ALLOW_EMPTY => True, 
    array('DateAll'), ), );
    $validate = array_merge($validate, $createFromCheck);
}

if (isset($_REQUEST['create_to'])) {
    $createToCheck = array('create_to' => array(Zynas_Filter_Input::ALLOW_EMPTY => True, 
    array('DateAll'), ), );
    $validate = array_merge($validate, $createToCheck);
}

if (isset($_REQUEST['control_number'])) {
    $controlNumberCheck = array('control_number' => array(Zynas_Filter_Input::ALLOW_EMPTY => True, 
...
if (isset($_REQUEST['txtCustomerCode'])) {
    $controlNumberCheck = array('txtCustomerCode' => array(Zynas_Filter_Input::ALLOW_EMPTY => True, ));
    $validate = array_merge($validate, $controlNumberCheck);
}
