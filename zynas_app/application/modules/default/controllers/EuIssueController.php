...
class EuIssueController extends Controller {
    ...
    public function confirmNextAction() {
        ...
        if (strcmp($issueRequest->ckPdf, '1') === 0) {
            ...
            try {
                ...
                if ($canAutoIssue && empty($issueRequest->customerFile))
        ...
        try {
            ...
            } elseif (strcmp($issueRequest->ckPdf, '1') === 0 && (!($canAutoIssue) || !empty($issueRequest->customerFile))) {
