...
class AdminIssueController extends Controller {
    ...
    public function requestAction(){
        ...
        $this->view->slProductCategory = $MCategory -> getSelectBoxCategoryAdmin(self::CHOOSE_DEFAULT_COMBOBOX);
        $this->view->slProductNumber = $MIssue -> getSelectBoxProductNumber(self::CHOOSE_DEFAULT_COMBOBOX,self::CATEGORY_DEVICE);
