...
class View_Helper_FormCheckBoxes extends Zynas_View_Helper {
    ...
    public function formCheckboxes($name, $value, $attribs = array(), $options = array(), $span = '%s&nbsp;%s', $delimiter = '&nbsp;&nbsp;', $isEscape = true) {
        ...
        foreach ($options as $optValue => $optCaption) {
            ...
            $checkboxes[] = sprintf($span, '<input type="checkbox" ' . implode(' ', $buff) . ' />', $optCaption);
            $index++;
        }
